...
<body>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form method="POST" id="kt_modal_add_user_form" class="form"
                                            action="/uploadVideo" enctype="multipart/form-data">
    ...
    <tbody class="text-gray-600 fw-bold">
        @foreach ($videos as $user)
        <tr>
            <td class="d-flex align-items-center">
                <div class="d-flex flex-column">
                    <a href="../../demo2/dist/apps/user-management/users/view.html"
                        class="text-gray-800 text-hover-primary mb-1">{{ $user->title }}</a>
                </div>
            </td>
            <td>
            ...
            <td>
                <div class="badge badge-light fw-bolder">{{ $user->day }}</div>
            </td>
            <td>
                <a onclick="changeVideo('{{ asset('upload/' . $user->video) }}')">
                    {{ $user->video }}
                </a>
            ...
            <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                    ...
                    <div class="menu-item px-3">
                        <a class="menu-link py-3" href="{{ route('editvideodetails', ['id' => $user->id]) }}">Edit</a>
                    </div>
                    <div class="menu-item px-3">
                        <a class="menu-link px-3" href="{{ route('delete', ['id' => $user->id]) }}">Delete</a>
                    </div>
                </div>
            </td>
        </tr>
