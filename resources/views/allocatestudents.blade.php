                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                <th class="min-w-300px">Cars</th>
                                <th class="min-w-350px">Fuel Type</th>
                                <th class="min-w-250px">Car Number</th>
                        ...
                        @foreach ($presentTrainer as $user)
                            <tr>
                                <!--begin::Name=-->
                                <td>{{ $user->car_name }}</td>
                                <td>
                                    <a href="../../demo1/dist/apps/user-management/roles/view.html"
                                        class="badge badge-light-primary fs-7 m-1">{{ $user->fuel_type }}</a>
                                </td>
