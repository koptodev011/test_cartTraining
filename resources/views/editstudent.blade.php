                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="modal-body scroll-y mx-8 mx-xl-25 my-7">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('updatestudent', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url({{ asset($employee->profile_photo_path) }});">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="user_shift" class="form-select form-select-solid mb-3 mb-lg-0">
