                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form method="POST" id="kt_modal_add_user_form" class="form"
                                            action="/addTest" enctype="multipart/form-data">

                                            @csrf

                                            <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Test Title</label>
                                                <input type="text" name="test-title"
                                                    class="form-control form-control-solid mb-3 mb-lg-0" />
                                            </div>
                                            <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Day</label>
                                                <input type="number" name="test-day"
                                                    class="form-control form-control-solid mb-3 mb-lg-0" />
                                            </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-550px">Test Title</th>
                                <th class="min-w-250px">Day</th>
                        ...
                        @foreach ($test as  $key => $user)
                            <tr>
                                <!--begin::Name=-->
                                <td> {{ $key + 1 }} </td>
                                <td>
                                    <a href="../../demo1/dist/apps/user-management/roles/view.html"
                                        class="badge badge-light-primary fs-7 m-1">{{ $user->test_title }}</a>
                                </td>
                                <td>{{ $user->test_day }}</td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <a class="menu-link py-3"
                                                href="{{ route('editTest', ['id' => $user->id]) }}">Edit</a>
                                        </div>
                                        ...
                                        <a class="menu-link py-3"
                                        href="{{ route('viewquestions', ['id' => $user->id]) }}">View</a>
                                        </div>
                                    </div>
                                </td>
                                <!--end::Action=-->
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ( $deletedTests as $key => $user)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $user->car_name }}</td>
