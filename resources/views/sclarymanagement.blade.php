                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <h2 class="fw-bolder">Search Records</h2>
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                            data-kt-users-modal-action="close">
                                            <span class="svg-icon svg-icon-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <!--begin::Form-->
                                        <form method="POST" id="kt_modal_add_user_form" class="form" action="/searchRecords"
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                ...
                <thead>
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Base sclary</th>
                        <th class="text-end min-w-100px">Sclary</th>
                    </tr>
                </thead>
                <tbody class="text-gray-600 fw-bold">
                    ...
                    <tr>
                        <td class="d-flex align-items-center">
                            <div class="d-flex flex-column">
                                <a href="../../demo2/dist/apps/user-management/users/view.html"
                                    class="text-gray-800 text-hover-primary mb-1">{{ $user->registration_no }}</a>
                            </div>
                        </td>
                        <td>{{ $user->name }}</td>
                        <td>{{ $user->role }}</td>
                        <td>
                            <div class="badge badge-light fw-bolder">{{ $user->attendance->count() }}</div>
                        </td>
                        <td>
                            <div class="badge badge-light fw-bolder">{{ date('F') }}</div>
                            <!-- Displaying current month dynamically -->
                        </td>
                        <td>
                            <div class="badge badge-light fw-bolder">{{ $user->sclary }}</div>
                        ...
                        <td class="text-end">
                            ...
                            $sclary = ($user->sclary / $daysExcludingSundays) * $user->attendance->count();
                            @endphp
                            {{ $sclary }}
                        </td>
                    </tr>
