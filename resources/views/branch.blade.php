                        ...
                        <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <!--begin::Form-->
                                        <form method="POST" id="kt_modal_add_user_form" class="form" action="/createbranch"
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    <label class="required fw-bold fs-6 mb-2">Branch Name</label>
                                                    <input type="text" name="branch_name"
                                                        class="form-control form-control-solid mb-3 mb-lg-0" />
                                                </div>

                                                <div class="fv-row mb-7">
                                                    <label class="required fw-bold fs-6 mb-2">Branch Address</label>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <!-- <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_edit_user" data-user-id="{{ $user->id }}">Edit</a> -->
                                    <!-- <a class="menu-link py-3"
                                        href="{{ route('employee', ['id' => $user->id]) }}">Edit</a> -->
                                        <a class="menu-link py-3" href="{{ route('editemployee', ['id' => $user->id]) }}">Edit</a>
