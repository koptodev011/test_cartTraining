...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        <div class="page d-flex flex-row flex-column-fluid">
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="{{ route('dashbord') }}">
                            ...
                            <div class="menu-item">
                                <a class="menu-link " href="{{ route('planeManagement') }}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link " href="{{ route('sclaryManagement') }}">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a class="menu-link " href="{{ route('videoupload') }}">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a class="menu-link " href="{{ route('expense') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="menu-item">
                                <a class="menu-link " href="{{ route('PresentTeachers') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <span class="menu-title">Student Allocation</span>
                                </a>
            ...
            <!-- //This is used to properly aligin the middle part -->
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank"
                                class="text-gray-800 text-hover-primary">Car Training</a>
                        </div>
